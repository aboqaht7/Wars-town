...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('إعداد-رحلات')
        .setDescription('تحديد روم التنبيهات وروم اشعار بدء الرحلة (أدمن فقط)')
        ...
        .addChannelOption(o => o.setName('روم-الرحلات').setDescription('الروم الذي يُرسل فيه اشعار بدء الرحلة').setRequired(true)),
    ...
    async slashExecute(interaction, db) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '✈️ روم بدء الرحلة', value: `<#${startChannel.id}>`, inline: true },
            )
